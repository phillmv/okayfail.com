...
What _are_ rent controls good for, then? So far, we've looked at how rent controls in Ontario are unlikely to be impacting new supply, and we have discussed why a well designed control should not have a serious impact on supply. That a regulation is relatively neutral does not justify its implementation. 
