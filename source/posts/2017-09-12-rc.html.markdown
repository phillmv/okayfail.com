...
The second generation began in the 1970s as rent control ordinances were passed in Boston, Los Angeles, San Francisco and in a variety of towns in California, Massachussets, New Jersey, New York, etc. The struture of Canadian federalism saw these policies accumulate at the provincial level, and during this period ten provinces also enacted rent controls (though most have since abandoned them). These policies "differed significantly from the first-generation rent control programs" and usually allowed automatic increases in rent, the passing through of additional costs, and included other like-minded provisions.[^arnott-1995]

Separating controls into "hard" and "soft" is not especially useful, though. Hans Lind, writing in 2001, goes on to define five distinct functional types of rent control. In his view, regulations can protect sitting tenants from being charged above-market rents (type A), or from increases in rent unattached to increases in costs (type B). Alternatively, regulations can instead bind to units and prevent landlords anywhere from charging above-market rents (type C), prevent rapid inflation by smoothing increases (type D) or, finally, prevent rents from ever reaching actual market prices (type E).[^lind-2001]

The takeway here is that when we talk about regulations, we have to be specific since their goals, mechanisms and therefore impacts are going to be different. New York City's rent controls, which Lind identifies as an extreme version of a type E control,[^lind-2001] are the most famous and well studied example, and unfortunately critics are quick to conflate all rent regulation with the kind experienced there. 

They're not wrong, per se: obviously, a control regime that over time lowers real income below that of real expenditures is a _bad idea_. It transforms rental properties into endless money pits. It's fine, and likely necessary, to subsidize some or other aspect of how we produce or provide housing units in order to achieve our policy goals &mdash; but it's unreasonable to expect that subsidy to be provided to the exclusive detriment of individual landlords. If investors wish to transfer their wealth to tenants they don't need to go through the trouble of erecting a building.  

But that's a false choice. We're not limited to between an unfettered market and a ruinously restrictive price control. When we discuss losses in efficiency and allocation, we're comparing our real world with a idealized perfectly competitive market where landlords compete to produce fungible, homogenous housing units, there are no externalities, every actor possesses perfect information, and so on. A landlord faced with increased demand is free to increase prices and profits accordingly. Abnormally high profits, though, attract other potential landlords who by virtue of adding to the supply of apartments will then drive down their prices.

Given a perfect market any sketch on a napkin will show that if prices are not allowed to rise with demand then new entrants will stay put, supply will not increase, and shortages will follow. However, given perfect competition, the market prices any landlord can fetch will over the long run equal their marginal cost, i.e. the amortized cost of building and operating a housing unit plus the landlord's opportunity cost. Put another way, in a _well functioning market_ it's more or less unreasonable to expect the rents any given landlord is able to extract will grow much faster than costs and inflation.

Arnott makes the case that housing markets are actually monopolistically competitive since housing structures and preferences are not homogenous, and there are substantial asymmetries in information and high transactions costs. Consequently, rents are set higher than their efficient level and the corresponding deadweight loss can be mitigated.[^arnott-2003] Bracketing that for now, though, the implication here is that while absolute price ceilings can be and are harmful there is no obvious reason why price _smoothing_ such that increases match but do not exceed costs should have a strong effect on the incentive to create new rental housing.[^arnott-2003-2]

<!--In a perfectly competitive market, a landlord faced with increased demand is free to increase prices and therefore profits accordingly. Abnormally high profits, though, attract other potential landlords who, by virtue of adding to the supply of apartments, will then drive down the price.  From this model, any sketch on a napkin will show, if prices are not allowed to rise with demand then new entrants will stay put, supply will not increase, and and shortages will follow. So far so good.

The flipside however is that, faced with perfect competition, the market price any landlord can fetch will over the long run equal their marginal cost, i.e. the cost of building and operating a housing unit plus the landlord's opportunity cost. This is to say, it's basically unreasonable to expect the rents any given landlord is able to charge to grow substantially beyond costs and inflation.
...
Arnott argues that housing markets are in fact monopolistically competitive, given that housing units are highly heterogenous and there are significant transaction costs. As a consequence, he 

Consider that in a perfectly competitive market, prices should approach the marginal cost and, capital expenditures aside, in principle therefore it's not really reasonable to expect rents to grow faster than inflation. 

Of course, housing markets as we experience them are far from perfectly competitive; for starters, supply is inelastic over the short to medium term. Arnott goes on to argue that housing units are highly heterogenous (i.e. not fungible commodities) and that since markets suffer from a variety of externalities and high transaction costs, and so on, such that a well-designed control could actually _improve_ on markets' unrestricted equilibrium.[^arnott-1995] [^nota-bene-2]-->

<h3>Ontario's rent control is rather soft</h3>


Recall that Ontario's current rent control regime pegs rents to inflation, does not control rents between tenants, and allows cost pass through.[^depressing] Lind categorized it as a type B control,[^lind-2001] and elsewhere it is variously called a kind of tenancy rent control or an intertenancy rent decontrol.
...
Consider Manitoba, whose regulation scheme is broadly similar.[^note-on-mb] Hugh Grant, writing in 2011, found that over the course of however many years there were likely little to no impact on the rental supply rate. He furthermore looked at rent increases and found that they actually were _below_ the fully prescribed increase rate.[^grant-2011]

Consider also the case of New Jersey, where a paper published in 2015 also found little to no effect on the supply of rental housing.

theoretical argument here on why it should be fine, blah blah recovery, ideal, arnott on no obvious reason why it should directly harm, followed by emprical evidence. new jersey is a type B control; manitoba broadly similar to ontario likewise.


"but if rent prices do not go up to match financial recovery rates that will hurt new supply" is a ridiculous argument since in that scenario the problem is land value appreciation over inflation causing rentals to be crowded out by other uses. while it's true that the price signalling mechanism is distorted by the controlled rent regime - and therefore rental buildings are not being adequately allocated by the market mechanism - it does not follow that the correct measure is to raise median rents and transfer income from landlords to tenants.

the relative attractiveness of ownership housing is a government policy; the relative scarcity of land via exclusionary zoning is a government policy; rental buildings as it stands today would not be built at all without the direct intervention of a government agency.[black, cmhc insurance rates]

the answer then is to tweak how we intervene.
...
<h2>A Brief History of Housing in Canada</h2>
...
[^nota-bene-2]: Normally here is where I'd present a literature review, but for our purposes I've chosen to gloss over the rather animated academic discussion. For a more elaborate and exhaustive treatment of the literature, see Lind (2001)[^lind-2001] and Lind (2003),[^lind-2003], Brescia (2005)[^brescia-2005], Grant (2011),[^grant-2011] and Ambrosius et al (2015).[^ambrosius-2015]

[^arnott-2003]: Arnott, R (2003). Tenancy Rent Control. Swedish Economic Policy Review, (10), 106

[^arnott-2003-2]: Arnott (2003, p. 98)

[^depressing]: Precisely because Ontario's rent regime is so tame makes having to write so much about it rather depressing.
