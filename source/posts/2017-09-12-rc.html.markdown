...
For the first time, the government began to tax capital gains; but it also changed the rate at which capital costs can be depreciated and it removed the ability to pool losses across rental buildings. It also prevented investors from outside the real estate business from claiming capital cost deductions or offset income via rental losses, and it altered how and which "soft" construction costs like architect fees, building permits, etc, can be deducted.[^hswg-2001] [^note-on-taxes]
