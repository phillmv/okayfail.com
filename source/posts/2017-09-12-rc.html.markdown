...
In this article, I begin by examining some arguments against rent controls, and revisit the evidence against them in Ontario's context. After comparing the historical data with more recent housing statistics, I then examine two contemporary policy changes that had outsized impacts on our housing markets. The first is the legalization of condominiums, in 1967, and the other was the overhaul of our income tax system in 1972.

After, I briefly review the literature and question the theoretical basis on which rent controls are criticized. I look up empirical research on rent controls in other communities and quickly discuss the nature of affordable housing development. I then approach the topic of security of tenure by first contextualizing it with the history of Canada's housing policy and the history of Ontario's tenant legislation, and finally I review the impact housing tenure has on residents.
