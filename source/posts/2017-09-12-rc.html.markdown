...
But that's a false choice. We're not limited to choosing between an unfettered market and a ruinously restrictive price control. After all, in a perfectly competitive market, prices should approach the marginal cost and, capital expenditures aside, therefore it's not really reasonable to expect rents to grow faster than inflation. Indeed, a well-designed control can improve on the unrestricted equilibrium of the imperfect housing markets as we experience them.[^arnott-1995] 
