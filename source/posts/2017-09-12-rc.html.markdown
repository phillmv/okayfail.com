...
<h3>Efficiency concerns are misplaced</h3>

another common concern is that rent controls will cause housing units to be misallocated, since units will no longer go to the people who "need" them the most. insert here lonely widow who still lives in a 3 bedroom.

this is utterly bonkers, and you can see why if you try to apply this to ownership where arguably the problem is far more rampant. what we have here is a normative claim encoded as an economics question.

a not dissimilar argument is made re: efficiency of labour markets, since with rent controls people tend to stay longer and therefore may not move to where jobs are. this is also bonkers, for the same reason as above.
