...
It's worth noting two things: first, that the economics of building a new rental building are distinct from the economics of operating an existing one, and second, the fact that the private market, in the absence of subsidies, can't afford to build new rental housing for people with low or even middle incomes.[^hswg-2001] [^black-2012]
...
There are many other factors and angles we haven't considered. Fluctuating interest rates, demographic trends and land prices have large impacts, and rental buildings and by extension tenants are further discriminated against by municipal property taxes and land use zoning restrictions. Our housing provisioning system is complicated.
...
Different regions have experiment with different kinds of rent control. The first wave, or generation, of controls were enacted during World War II and they imposed nominal rent freezes.[^arnott-1995] In a planned war economy that lacked much in the way of private housing construction, this made a certain amount of sense; but afterwards, only New York City maintained that wartime policy, and commentators criticizing rent controls are usually referring to that jurisdiction's experience.

Obviously, a control regime that over time lowers real income below that of real expenditures is a _bad idea_. It's fine, and likely necessary, to subsidize some or other aspect of how we produce or provide rental units in order to achieve our housing policy goals &mdash; but it's unreasonable to expect that subsidy to be provided to the exclusive detriment of individual landlords. If investors want to transfer their wealth to tenants, they don't really need to go through the trouble of erecting a building first.

However, we're not limited to choosing between an unfettered market and a ruinously restrictive price control. After all, our purpose is to provide tenants with security of tenure by protecting them from runaway price inflation. Given the long-term nature of multi-residential investment, their business model can be satisfied so long as cashflows keep up with costs. After all, in a laissez faire but well-functioning market, there is no guarantee that rents will rise above inflation. 

A cost-adjusted tenancy control, then, primarily impacts only one area of the development process: the initial lease up of an empty building.[^tait-2017] As long as developers have the ability to adjust for initial mistakes, over the long run the impact on their finances should be reasonable if not minimal.
...
Ultimately, our housing crisis is a matter of income: tenants with low incomes have an _income_ problem, not a housing problem.[^hswg-final] Land prices and other costs, driven by restrictive zoning and the speculative condo boom, have grown faster than tenant incomes and pushed recovery rents beyond what most of the rental population can afford or finds reasonable.
...
<h3>Reminder: rents are unproductive</h3>
