...
Here is what I will not be arguing for. Some think that rent controls assist in the preservation of affordability, or have virtuous redistributional effects. I believe these views are incorrect. For one, there are more efficient and politically durable ways to redistribute income. As to the other, absent a radical reorientation of land rights the cost of new supply remains tied to the yoke of interest rates and land values &mdash; and therefore a price control won't help us.
...
I'd like to advance a positive argument for rent regulation, and so here is what I will _not_ be arguing for. Supporters of rent controls may claim they preserve affordability, or have virtuous redistributive effects. I believe these views are incorrect. As for the latter, there are other, more efficient, useful and politically durable ways to redistribute income. And, absent a radical reorientation of land rights, the cost of new supply is tied to the yoke of interest rates and land values, and a price control won't help us. -->
...
Recall that Ontario's current rent control regime, which Lind categorized as a type B control,[^lind-2001] pegs rents to inflation, does not control rents between tenants, and allows cost pass throughs.[^depressing] Elsewhere it is variously called a tenancy rent control or intertenancy rent decontrol.
