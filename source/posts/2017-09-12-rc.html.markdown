...
By definition, low vacancies occur because there are more people searching for housing than there are available units. It takes several years to build a new house or apartment, which is why the supply of new housing is typically considered "inelastic".
