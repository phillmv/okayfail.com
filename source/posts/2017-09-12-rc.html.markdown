...
When we talk about preventing the regulation of rents, bracketing poorly designed controls, the concern then is about keeping median rent levels on par with rising land prices. Rents in a newly constructed building must cover their costs; land values per acre in the Greater Toronto Area have tripled over the last decade. In 2016 rents in Toronto increased by 11% to reach a record average of $2.77 per square foot but new rental projects must charge over $3 psf.[^tal-cibc-2]
