...
Reviewing the literature on the topic, I was able to identify two other significant events. The first happened in 1967, when Ontario legalized condominiums &mdash; and created a new form of property ownership, substantially altering the economics behind multi-residential buildings.
...
Prior to the Condominium Act, apartment buildings could only be rented out or sold in their entirety. Now, for the first time, title could be given to each individual unit, greatly increasing the allowed density of privately owned housing &mdash; which was a boon for developers. Condominiums immediately began to crowd out rental building investment: the first condo in Ontario was originally constructed as a rental and was later converted to a condominium soon after the law came into effect.[^hanes-2008]
...
All of this conspires to make profit margins in the multi-residential investment market very narrow; what might be a suitable rate of return for an insurance company looking to operate a rental building may be insufficient for a developer to build a new one.[^hswg-2001] Small shifts in financing terms, land values, taxation and the costs incurred due to delays in the regulatory planning process can have huge impacts in the feasibility of a given project.

Condos weren't the only thing that changed, though.


<h3>The new taxation regime</h3>

The other significant event occurred in 1972, when the federal government overhauled our income tax system. 
...
Of course, there are many other factors and angles we haven't considered. Fluctuating interest rates, demographic trends and surging land prices have large impacts. Tenants are further discriminated against through municipal property taxes and exclusionary zoning restrictions. The list goes on; our housing provisioning system is complicated. But it seems unlikely that rent controls qua rent controls are the main disincentive.
...
Different regions have experiment with different kinds of rent control. The first wave, or generation, of controls were enacted during World War II and they imposed nominal rent freezes.[^arnott-1995] In a planned war economy that lacked much in the way of private housing construction, this made a certain amount of sense; but afterwards, only New York City maintained that wartime policy, and commentators criticizing rent controls are quick to point to that jurisdiction's experience.

Obviously, a control regime that over time lowers real income below that of real expenditures is a _bad idea_. It's fine, and likely necessary, to subsidize some or other aspect of how we produce or provide rental units in order to achieve our housing policy goals &mdash; but it's unreasonable to expect that subsidy to be provided to the exclusive detriment of individual landlords. If investors want to transfer their wealth to tenants, they don't need to go through the trouble of erecting a building first.

However, we're not limited to choosing between an unfettered market and a ruinously restrictive price control. When designing a control, we can choose to allow prices to track inflation, to what extent capital investments can be recovered, and whether or at what rate units can reset to what the market will bear between tenants.


A cost-adjusted tenancy control primarily impacts only one area of the development process: the initial lease up of an empty building.[^tait-2017] As long as developers have the ability to adjust for initial mistakes, over the long run the impact on their finances should be reasonable if not minimal.[^ryerson-whatever] Given the long-term nature of multi-residential investment, their business model can be satisfied so long as cashflows keep up with costs and capital expenditures. After all, in a laissez faire but well-functioning market, landlords prefer long-term tenants and there is no guarantee that rents will rise above inflation. 
...
Ultimately, our housing crisis is a matter of income: tenants with low incomes have an _income_ problem, not a housing problem.[^hswg-final] Land prices and other costs, driven by restrictive land use policies and the speculative condo boom, have grown faster than tenant incomes and pushed recovery rents beyond what most of the rental population can afford or finds reasonable.
...
[^hswg-2001]: Housing Supply Working Group. (2001) Affordable Rental Housing Supply: The Dynamics of the Market and Recommendations for Encouraging New Supply (p. 9-14, Interim Report). (2001, May)
