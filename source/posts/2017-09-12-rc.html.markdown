...
There is some reason to doubt these numbers prima facie, since converted housing units remain part of the housing stock &mdash; and a large percentage of condominiums get rented out to tenants without this necessarily being reflected in most housing data sources. It may be more accurate to say that primary rental units are being converted to ownership _and_ the secondary rental market. In addition, California's Ellis Act creates an unusually permissive environment for conversions. 

Contrast with Massachussets, where they were largely prohibited: Sims found that "rent decontrol is associated with an 8 percentage point increase in the probability of a unit being a condominium", presumably since restrictions on conversions were lifted.[^sims-2007] Nevertheless, it seems fair to conclude that keeping units below market rates exacerbates the incentive towards redeveloping them.

Yet, reading these papers I can't help but think that the actual problem has more to do with rising land values and the lack of new supply. San Francisco, rather famously, doesn't build much in the way of new housing despite creating torrents of well paid jobs.[^torres-2017]
