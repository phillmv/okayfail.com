...
<h3>Other huge disincentives</h3>
...
That said, it's worth noting that the economics of building a new rental building are distinct from the economics of operating an existing one. In fact, it seems that historically the private market's willingness to build large quantities of rental buildings is a function of the extent they're effective short and medium term _tax shelters_.


<h3>Not all controls are designed equal</h3>

This isn't to say that price controls are uniformly great. Obviously, a control regime that over time lowers real income below that of real expenditures is a _bad idea_. It's fine, and probably necessary, to subsidize some aspects of renting in order to achieve our housing policy goals, but it's not really rational to expect that to come exclusively at the economic detriment of landlords.
